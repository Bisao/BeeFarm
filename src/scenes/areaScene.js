...
export export class AreaScene extends Scene {
    constructor() {
        ...
        this.gridSize = 50;
        this.gridWidth = 15; // Tamanho diferente da área
        this.gridHeight = 15;
        this.offset = { x: 0, y: 0 };
    ...
    drawGrid() {
        // Similar ao GameScene, mas com diferentes cores ou padrões
        ...
        for (let y = 0; y < this.gridHeight; y++) {
            for (let x = 0; x < this.gridWidth; x++) {
                ...
                this.ctx.lineTo(centerX/this.scale + isoX - this.gridSize / 2, centerY/this.scale + isoY + this.gridSize / 4);
                this.ctx.closePath();
                this.ctx.strokeStyle = '#8B4513'; // Cor diferente para esta área
                this.ctx.stroke();
            }
        }
        this.ctx.restore();
